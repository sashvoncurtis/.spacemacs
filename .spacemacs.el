...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (dart :variables
           dart-backend 'lsp
           lsp-dart-sdk-dir "<path>/flutter/bin/cache/dart-sdk/"
           lsp-enable-on-type-formatting t
           dart-server-enable-analysis-server t
           dart-server-sdk-path "<path>/flutter/bin/cache/dart-sdk/")
     ;; git
     helm
     ;; lsp
     ;; markdown
